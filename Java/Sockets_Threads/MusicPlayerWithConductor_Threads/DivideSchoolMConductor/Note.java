...
public class Note
{
	...
	{
		public static final int sixty_fourth = 1;// 1/16
		public static final int thirty_second = sixty_fourth*2;// 2/16
		public static final int sixteenth = thirty_second*2;// 4/16
		public static final int eight = sixteenth*2;// 8/16
		public static final int quarter = eight*2;// 16/16
		public static final int half = quarter*2;// 32/16
		public static final int whole = half*2;// 64/16
		
		//SP
		public static final int semifusa = sixty_fourth;// 1/16
		public static final int fusa = thirty_second;// 2/16
		public static final int semicorchea = sixteenth;// 4/16
		public static final int corchea = eight;// 8/16
		public static final int negra = quarter;// 16/16
		public static final int blanca = half;// 32/16
		public static final int redonda = whole;// 64/16
	}
}