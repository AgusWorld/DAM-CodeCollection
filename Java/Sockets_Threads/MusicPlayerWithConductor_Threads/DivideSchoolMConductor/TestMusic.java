...
public class TestMusic
{
	public static void main(String[] args)
	{
		...
		executorS.submit(conductor);
		
			
		Performer mozart=new Performer(trombone58,conductor);
		Performer mozart2=new Performer(trumpet57,conductor);
		Performer mozart3=new Performer(chorus54,conductor);
		executorS.submit(mozart);
		executorS.submit(mozart2);
		executorS.submit(mozart3);
